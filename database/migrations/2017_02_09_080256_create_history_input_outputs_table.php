...
class CreateHistoryInputOutputsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('history_input_outputs', function (Blueprint $table) {
            ...
            $table->bigInteger('quantum_in')->default(0)->unsigned()->comment('Số lượng nạp');
            $table->bigInteger('quantum_out')->default(0)->unsigned()->comment('Số lượng bán');
            $table->bigInteger('quantum_remain')->default(0)->unsigned()->comment('Số lượng còn lại');
            $table->bigInteger('sum_in')->default(0)->unsigned()->comment('Tổng nhập');
            $table->bigInteger('sum_out')->default(0)->unsigned()->comment('Tổng xuất');
